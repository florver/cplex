# -*- coding: utf-8 -*-
"""field_services_prueba.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jNSGD69FEpKNv0MN3vTHn68okR7Y8Y1k
"""
        ...
        for j in range(data.cantidad_trabajadores):
          for d in range(data.dias):
            for t in range(data.turnos):
              ...
              values = [1]*len(variables_restriccion)
              row = [variables_restriccion, values]
              my_problem.linear_constraints.add(lin_expr=[row], senses=['G'], rhs=[float(data.ordenes[n].trabajadores_necesarios)])
