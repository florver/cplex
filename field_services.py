        ...
        for d in range(data.dias):
          for t in range(data.turnos):
            ...
            for j in range(data.cantidad_trabajadores):
              ...
              values = list([[1]*len(variables_restriccion), [-data.ordenes[data.ordenes_correlativas[n][0]].trabajadores_necesarios]*len(variables_restriccion_delta)])
        ...
        for d in range(data.dias):
          for t in range(data.turnos):
            ...
            for j in range(data.cantidad_trabajadores):
              ...
              values = list([[1]*len(variables_restriccion), [-data.ordenes[data.ordenes_correlativas[n][1]].trabajadores_necesarios]*len(variables_restriccion_delta)])
              row = [list([variables_restriccion, variables_restriccion_delta]), values]
